...
##################################
DOWNLOAD_ORIGINAL_URL: Optional[Union[str, dict]] = "https://zenodo.org/record/7884270"
...
PAPER: Optional[Union[str, List[str], Dict[str, str]]] = ["https://www.mdpi.com/2306-5729/8/7/118"]
BLOGPOST: Optional[Union[str, List[str], Dict[str, str]]] = None
REPOSITORY: Optional[Union[str, List[str], Dict[str, str]]] = None

CITATION_URL: Optional[str] = "https://zenodo.org/record/7884270"
...
SLYTAGSPLIT: Optional[Dict[str, Union[List[str], str]]] = {
    "__PRETEXT__": "Note, that *background* class has been removed due to possible misinterpretation of data"
}
